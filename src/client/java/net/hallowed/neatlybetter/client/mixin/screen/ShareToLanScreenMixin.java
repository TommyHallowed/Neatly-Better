...
public abstract class ShareToLanScreenMixin extends Screen {
    ...
    private CycleButton<@NotNull GameType> neatlybetter$centerGameModeButtonIfLocked(CycleButton<@NotNull GameType> button) {
    ...
    private CycleButton<@NotNull Boolean> neatlybetter$hideCheatButtonIfLocked(CycleButton<@NotNull Boolean> button) {
        IntegratedServer server = this.minecraft.getSingleplayerServer();
        if (server != null && !server.getWorldData().isAllowCommands()) {
            button.active = false;
